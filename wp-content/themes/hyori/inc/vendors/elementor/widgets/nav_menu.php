...
class Hyori_Elementor_Nav_Menu extends Widget_Base {

	public function get_name() {
        return 'hyori_nav_menu';
    }

	public function get_title() {
        return esc_html__( 'Goal Navigation Menu', 'hyori' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'hyori' ),
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'hyori' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'hyori' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'hyori' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'hyori' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Hyori_Elementor_Nav_Menu );