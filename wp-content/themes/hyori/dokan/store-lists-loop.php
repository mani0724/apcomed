<div id="dokan-seller-listing-wrap">
    <div class="seller-listing-content">
        <?php if ( $sellers['users'] ) : ?>
            <ul class="dokan-seller-wrap">
                ...
                foreach ( $sellers['users'] as $seller ) {
                    ...
                    $store_name = isset( $store_info['store_name'] ) ? esc_html( $store_info['store_name'] ) : esc_html__( 'N/A', 'hyori' );
                    ...
                    <li class="dokan-single-seller woocommerce coloum-<?php echo esc_attr($per_row); ?> <?php echo ( ! $banner_id ) ? 'no-banner-img' : ''; ?>">
                        <div class="store-wrapper">
                                    ...
                                    <div class="store-data-container">
                                        <div class="featured-favourite">
                                            <?php if ( ! empty( $featured_seller ) && 'yes' == $featured_seller ): ?>
                                                <div class="featured-label"><?php esc_html_e( 'Featured', 'hyori' ); ?></div>
                                            <?php endif ?>
                                        ...
                                        <div class="store-data">
                                            ...
                                            <?php if ( !empty( $seller_rating['count'] ) ): ?>
                                                <div class="star-rating dokan-seller-rating" title="<?php echo sprintf(__( 'Rated %s out of 5', 'hyori' ), $seller_rating['rating'] ) ?>">
                            ...
                            <div class="store-footer">
                                ...
                                <a href="<?php echo esc_url($store_url); ?>" class="btn btn-theme btn-outline"><?php esc_html_e( 'Visit Store', 'hyori' ); ?></a>
            ...
            if ( $num_of_pages > 1 ) {
                ...
                $pagination_args = array(
                    ...
                    'type'      => 'array',
                    'prev_text' => esc_html__( '&larr; Previous', 'hyori' ),
                    'next_text' => esc_html__( 'Next &rarr;', 'hyori' ),
                );
        ...
        <?php else:  ?>
            <p class="dokan-error"><?php esc_html_e( 'No vendor found!', 'hyori' ); ?></p>
        <?php endif; ?>
    </div>
</div>