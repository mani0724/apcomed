...
function cmb2_ajax_search_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => __( 'Attached posts Metabox', 'wp-realestate' ),
		'object_types'  => array( 'page', 'post' ), // Post type
	) );

	// Single post
	$cmb_demo->add_field( array(
		'name'          => __( 'Attached post', 'wp-realestate' ),
		'desc'          => __( 'Field description (optional)', 'wp-realestate' ),
		'id'            => $prefix . 'post',
	...
	// Multiple posts
	$cmb_demo->add_field( array(
		'name'          => __( 'Multiple posts', 'wp-realestate' ),
		'desc'          => __( 'Field description (optional)', 'wp-realestate' ),
		'id'            => $prefix . 'posts',
		'type'          => 'post_ajax_search',
		'multiple'      => true,
	...
	// Multiple users
	$cmb_demo->add_field( array(
		'name'          => __( 'Multiple users', 'wp-realestate' ),
		'desc'          => __( 'Field description (optional)', 'wp-realestate' ),
		'id'            => $prefix . 'users',
		'type'          => 'user_ajax_search',
		'multiple'      => true,
	...
	// Single term
	$cmb_demo->add_field( array(
		'name'          => __( 'Attached term', 'wp-realestate' ),
		'desc'          => __( 'Field description (optional)', 'wp-realestate' ),
		'id'            => $prefix . 'term',
	...
	// Multiple terms
	$cmb_demo->add_field( array(
		'name'          => __( 'Multiple terms', 'wp-realestate' ),
		'desc'          => __( 'Field description (optional)', 'wp-realestate' ),
		'id'            => $prefix . 'terms',
		'type'          => 'term_ajax_search',
		'multiple'      => true,
